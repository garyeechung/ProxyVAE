...
def train_proxyvae(model: Module, data_dir: str, ckpt_dir: str,
                   beta1: float, beta2: float, device: str,
                   batch_size: int = 500, epochs: int = 300, lr: float = 5e-4,
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig(os.path.join(ckpt_dir, "proxyvae_losses.png"))
    plt.close()
