...
def train_posthoc_group(model: Module, data_dir: str, ckpt_dir: str,
                        beta1: float, beta2: float, device: str, merge_group=MERGE_GROUP,
    ...
    ckpt_path = os.path.join(ckpt_dir, "posthoc_group.pth")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(ckpt_dir, "posthoc_group_losses.png"))
    plt.close()
